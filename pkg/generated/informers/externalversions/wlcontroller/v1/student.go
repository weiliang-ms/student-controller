...
import (
	...
	versioned "student-controller/pkg/generated/clientset/versioned"
	internalinterfaces "student-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "student-controller/pkg/generated/listers/wlcontroller/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WlcontrollerV1().Students(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WlcontrollerV1().Students(namespace).Watch(options)
			},
		},
		&wlcontrollerv1.Student{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wlcontrollerv1.Student{}, f.defaultInformer)
}
